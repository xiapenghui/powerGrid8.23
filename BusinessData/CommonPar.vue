      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="150px" class="demo-ruleForm">
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-form-item label="采购方公司省份" prop="buyerProvince"><el-input v-model="ruleForm.buyerProvince" :disabled="true" /></el-form-item>
            ...
            <el-form-item label="订单类型"><el-input v-model="ruleForm.ipoType" /></el-form-item>
            <el-form-item label="供应商名称"><el-input v-model="ruleForm.supplierName" /></el-form-item>
            ...
            <el-form-item label="波形信息"><el-input v-model="ruleForm.wavyStatus" /></el-form-item>
            <el-form-item label="备注"><el-input v-model="ruleForm.itemRemark" /></el-form-item>
          </div>
          <div class="boxRight">
            <el-form-item label="产成品编码" prop="productName"><el-input v-model="ruleForm.productCode" /></el-form-item>
            ...
            <el-form-item label="采集规范版本号 "><el-input v-model="ruleForm.standardVersion" /></el-form-item>
            <el-form-item label="国网侧供应商编码" prop="supplierCode"><el-input v-model="ruleForm.supplierCode" /></el-form-item>
            <el-form-item label="规格型号编码 "><el-input v-model="ruleForm.modelCode" /></el-form-item>
            ...
            <el-form-item label="是否合格 " prop="isQualified"><el-input v-model="ruleForm.isQualified" /></el-form-item>
