...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/demo/api/eip/pi/import/file',
      // 日志分页
      paginationLog: {
        current: 1,
        size: 10
      ...
      rules: {
        ...
        materialsName: [{ required: true, message: '请输入物资名称', trigger: 'blur' }],
        poNo: [{ required: true, message: '请输入国网采购订单号', trigger: 'blur' }],
