<template>
  <div class="app-container">
    <div class="search">
      <el-row :gutter="20">
        <el-col :span="8">
          ...
          <el-col :span="16">
            <el-input v-model="listQuery.entityCode" :placeholder="$t('permission.entityCode')" clearable />
          </el-col>
        </el-col>
    ...
    <el-table v-loading="listLoading" :header-cell-style="{ background: '#008284',color:'#ffffff' }" :data="tableData"
      :height="tableHeight" style="width: 100%" border element-loading-text="拼命加载中" fit highlight-current-row
        ...
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-form-item label="实物ID" prop="entityCode">
              <el-input v-model="ruleForm.entityCode" />
            </el-form-item>
            <el-tooltip class="item" effect="dark" content="采购订单号（去前面的0）" placement="top-start">
              <el-form-item label="采购订单号（去前面的0）" prop="poNo">
                <el-input v-model="ruleForm.poNo" />
              </el-form-item>
            </el-tooltip>
            <el-form-item label="采购订单行项目号" prop="poItemNo">
              <el-input v-model="ruleForm.poItemNo" />
            </el-form-item>
            <el-form-item label="采购订单行项目id">
              <el-input v-model="ruleForm.poItemId" />
            </el-form-item>
          ...
          <div class="boxRight">
            <el-form-item label="采购方总部编码">
              <el-input v-model="ruleForm.purchaserHqCode" :disabled="true" />
            </el-form-item>
            <el-form-item label="供应商编码">
              <el-input v-model="ruleForm.supplierCode" :disabled="true" />
            </el-form-item>
            <el-form-item label="供应商名称">
              <el-input v-model="ruleForm.supplierName" :disabled="true" />
            </el-form-item>
            <el-form-item label="数据来源">
              <el-input v-model="ruleForm.dataSource" :disabled="true" />
            </el-form-item>
            <el-form-item label="数据可见方">
              <el-input v-model="ruleForm.openId" :disabled="true" />
            </el-form-item>
    ...
    <!-- 上传文件弹窗 -->
    <ImprotFile :dialog-visible="dialogVisible" :improt-loading="improtLoading" :production-url="productionUrl"
      @handleavatarsuccess="handleAvatarSuccess" @beforeavatarupload="beforeAvatarUpload" @fileClose="fileClose" />

    <pagination v-show="total > 0" :total="total" :current.sync="pagination.current" :size.sync="pagination.size"
      @pagination="getList" />
  </div>
</template>
