      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          ...
          <div class="boxRight">
            ...
            <el-form-item label="物资名称"><el-input v-model="ruleForm.productName" /></el-form-item>
            ...
            <el-form-item label="来源数据创建时间" prop="dataSourceCreatetime"><el-input v-model="ruleForm.dataSourceCreatetime" /></el-form-item>
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/demo/api/eip/mi/import/file',
      // 日志分页
      paginationLog: {
        current: 1,
        size: 10
      ...
      rules: {
        ...
        matDescription: [{ required: true, message: '请输入原材料描述', trigger: 'blur' }],
