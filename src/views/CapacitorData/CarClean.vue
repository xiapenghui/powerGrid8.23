        ...
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-tooltip class="item" effect="dark" content="洁净度（0.5μm），单位：个/m³" placement="top-start">
              <el-form-item label="洁净度（0.5μm），单位：个/m³" prop="cleanClass">
                <el-input v-model="ruleForm.cleanClass" />
              </el-form-item>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="洁净度，仅数字，单位：个/升" placement="top-start">
              <el-form-item label="洁净度，仅数字，单位：个/升" prop="cleanLiness">
                <el-input v-model="ruleForm.cleanLiness" />
              </el-form-item>
            </el-tooltip>
          ...
          <div class="boxRight">
            ...
            <el-tooltip class="item" effect="dark" content="洁净度，仅数字，单位：个/升" placement="top-start">
              <el-form-item label="洁净度，仅数字，单位：个/升" prop="unitCleanClass">
                <el-input v-model="ruleForm.unitCleanClass" />
              </el-form-item>
            </el-tooltip>

            <el-tooltip class="item" effect="dark" content="洁净度，仅数字，单位：个/升" placement="top-start">
              <el-form-item label="洁净度，仅数字，单位：个/升" prop="unitCleanLiness">
                <el-input v-model="ruleForm.unitCleanLiness" />
              </el-form-item>
            </el-tooltip>
        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="洁净度（0.5μm），单位：个/m³:">
                <span>{{ props.row.requestBody.cleanClass }}</span>
              </el-form-item>
              <el-form-item label="洁净度单位：个/升:">
                <span>{{ props.row.requestBody.unitCleanClass }}</span>
              </el-form-item>
              <el-form-item label="洁净度单位：个/升:">
                <span>{{ props.row.requestBody.cleanLiness }}</span>
              </el-form-item>
              <el-form-item label="洁净度单位：个/升:">
                <span>{{ props.row.requestBody.unitCleanLiness }}</span>
              </el-form-item>
            </el-form>
          </template>
        </el-table-column>
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/demo/api/drq/dianrongqi6/import/file',
      myHeaders: {
