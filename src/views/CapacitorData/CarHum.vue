<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.humidityMax')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.humidityMax }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.humidityMin')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.humidityMin }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.humidity')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.humidity }}
        </template>
      </el-table-column>
      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-form-item label="额定湿度上限值" prop="humidityMax"><el-input v-model="ruleForm.humidityMax" /></el-form-item>
            <el-form-item label="湿度" prop="humidity"><el-input v-model="ruleForm.humidity" /></el-form-item>
          ...
          <div class="boxRight">
            ...
            <el-form-item label="额定湿度下限值" prop="humidityMin"><el-input v-model="ruleForm.humidityMin" /></el-form-item>
...
import { sdList, sdDellte, sdEdit, allLogs } from '@/api/business'
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        humidityMax: [{ required: true, message: '请输入额定湿度上限值', trigger: 'blur' }],
        humidityMin: [{ required: true, message: '请输入额定湿度下限值', trigger: 'blur' }],
  ...
  methods: {
    ...
    getList() {
      ...
      sdList(this.pagination, this.listQuery).then(res => {
