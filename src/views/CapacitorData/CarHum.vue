      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-form-item label="额定湿度上限值" prop="humidityMax">
              <el-input v-model="ruleForm.humidityMax" />
            </el-form-item>
            <el-form-item label="湿度" prop="humidity">
              <el-input v-model="ruleForm.humidity" />
            </el-form-item>
          ...
          <div class="boxRight">
            ...
            <el-form-item label="额定湿度下限值" prop="humidityMin">
              <el-input v-model="ruleForm.humidityMin" />
            </el-form-item>
        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="额定湿度上限值:">
                <span>{{ props.row.requestBody.humidityMax }}</span>
              </el-form-item>
              <el-form-item label="额定湿度下限值:">
                <span>{{ props.row.requestBody.humidityMin }}</span>
              </el-form-item>
              <el-form-item label="湿度:">
                <span>{{ props.row.requestBody.humidity }}</span>
              </el-form-item>
            </el-form>
          </template>
        </el-table-column>
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/demo/api/drq/dianrongqi5/import/file',
      myHeaders: {
