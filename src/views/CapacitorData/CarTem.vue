<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.temperatureMax')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.temperatureMax }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.temperatureMin')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-form-item label="额定温度上限值" prop="temperatureMax"><el-input v-model="ruleForm.temperatureMax" /></el-form-item>
            <el-form-item label="温度" prop="temperature"><el-input v-model="ruleForm.temperature" /></el-form-item>
          ...
          <div class="boxRight">
            ...
            <el-form-item label="额定温度下限值" prop="temperatureMin"><el-input v-model="ruleForm.temperatureMin" /></el-form-item>
...
import { wdList, wdDellte, wdEdit, allLogs } from '@/api/business'
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/linx/dianrongqi_4/import/file',
      ...
      rules: {
        ...
        temperatureMax: [{ required: true, message: '请输入额定温度上限值', trigger: 'blur' }],
        temperatureMin: [{ required: true, message: '请输入额定温度下限值', trigger: 'blur' }],
  ...
  methods: {
    ...
    getList() {
      ...
      wdList(this.pagination, this.listQuery).then(res => {
