      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-form-item label="额定温度上限值" prop="temperatureMax">
              <el-input v-model="ruleForm.temperatureMax" />
            </el-form-item>
          ...
          <div class="boxRight">
            ...
            <el-form-item label="额定温度下限值" prop="temperatureMin">
              <el-input v-model="ruleForm.temperatureMin" />
            </el-form-item>
        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="额定温度上限值:">
                <span>{{ props.row.requestBody.temperatureMax }}</span>
              </el-form-item>
              <el-form-item label="额定温度下限值:">
                <span>{{ props.row.requestBody.temperatureMin }}</span>
              </el-form-item>
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/demo/api/drq/dianrongqi4/import/file',
      myHeaders: {
