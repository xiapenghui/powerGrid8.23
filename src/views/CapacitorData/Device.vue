<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.parDischangeRn')" width="180" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.parDischangeRn }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.parDischangeM')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="额定放电电阻值单位是MΩ:">
                <span>{{ props.row.requestBody.parDischangeRn }}</span>
              </el-form-item>
              <el-form-item label="放电电阻值单位是MΩ:">
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/demo/api/drq/dianrongqi14/import/file',
      myHeaders: {
  ...
  methods: {
    ...
    getList() {
      ...
      fdqList(this.pagination, this.listQuery).then(res => {
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          fdqEdit(this.ruleForm).then(res => {
            if (res.code === 200) {
              this.$message({
                type: 'success',
