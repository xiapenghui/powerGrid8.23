<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.isQualifyJBX')" width="200" :show-overflow-tooltip="true">
        <template slot-scope="scope">
          {{ scope.row.isQualify }}
        </template>
      </el-table-column>

      <el-table-column align="center" :label="$t('permission.checkResultJBX')" width="170" :show-overflow-tooltip="true">
        <template slot-scope="scope">
      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="150px" class="demo-ruleForm">
        <div class="bigUpBox">
          <div class="boxLeft">
            ...
            <el-form-item label="薄膜厚度(µm)" prop="filmThickness">
          ...
          <div class="boxRight">
            ...
            <el-form-item label="规格型号编码默认" prop="modelCode">
        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="薄膜厚度(µm):">
                <span>{{ props.row.requestBody.filmThickness }}</span>
              </el-form-item>
              <el-form-item label="电弱点个数额定值:">
                <span>{{ props.row.requestBody.electricalWeaknessUn }}</span>
              </el-form-item>
              <el-form-item label="电弱点个数(个/m2):">
                <span>{{ props.row.requestBody.electricalWeakness }}</span>
              </el-form-item>
              <el-form-item label="(聚丙烯薄膜)检验结果是否合格:">
                <span>{{ props.row.requestBody.isQualify }}</span>
              </el-form-item>
              <el-form-item label="(聚丙烯薄膜)检查结果附件:">
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/demo/api/drq/dianrongqi1/import/file',
      myHeaders: {
      ...
      rules: {
        ...
        electricalWeakness: [{
          required: true,
          message: '请输入电弱点个数(个/m2)',
          trigger: 'blur'
        }],
        isQualify: [{
          required: true,
          message: '请输入(聚丙烯薄膜)检验结果是否合格',
          trigger: 'blur'
        }]
