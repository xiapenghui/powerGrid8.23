      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          ...
          <div class="boxRight">
            ...
            <el-form-item label="一次额定电流 " prop="ratedCurrent">
              <el-input v-model="ruleForm.ratedCurrent" />
            </el-form-item>
            <el-form-item label="一次耐压额定值 " prop="pressureValueUn">
            ...
            <el-form-item label="耐压持续额定时间 " prop="MatepressureTimeUnrialSN">
              <el-input v-model="ruleForm.MateripressureTimeUnalSN" />
            </el-form-item> <el-form-item label="耐压持续时间" prop="pressureTime">
              <el-input v-model="ruleForm.pressureTime" />
            </el-form-item>
            <el-form-item label="额定局放量 " prop="dischargeUn">
              <el-input v-model="ruleForm.dischargeUn" />
            </el-form-item> <el-form-item label="A相局放量 " prop="dischargeA">
