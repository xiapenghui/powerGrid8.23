      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="130px" class="demo-ruleForm">
        <div class="bigUpBox">
          ...
          <div class="boxRight">
            ...
            <el-form-item label="一次额定电压" prop="pressureValueUn">
            ...
            <el-form-item label="启辉电压上限值  " prop="articulationMax">
              <el-input v-model="ruleForm.articulationMax" />
            </el-form-item>
            <el-form-item label="启辉电压下限值  " prop="articulationMin">
              <el-input v-model="ruleForm.articulationMin" />
            </el-form-item>
            <el-form-item label="显示清晰度试验  " prop="articulationTest">
              <el-input v-model="ruleForm.articulationTest" />
            </el-form-item>
            ...
            <el-form-item label="带电显示器批次号 " prop="rmLot">
