      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="150px" class="demo-ruleForm">
        <div class="bigUpBox">
          ...
          <div class="boxRight">
            ...
            <el-form-item label="额定电流值 " prop="ratedCurrent">
              <el-input v-model="ruleForm.ratedCurrent" />
            </el-form-item>
            <el-form-item label="持续运行电流值 " prop="continuousCurrent">
              <el-input v-model="ruleForm.continuousCurrent" />
            </el-form-item>
            ...
            <el-form-item label="熔断器批次号" prop="rmLot">
