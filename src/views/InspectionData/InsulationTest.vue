<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" :label="$t('permission.pressureValueTwo')" width="180" :show-overflow-tooltip="true">
        <template slot-scope="scope">
    ...
    >
      <el-upload
        ref="upload"
        class="upload-demo"
        :action="this.GLOBAL.BASE_URL + '/demo/api/kvsc/acit/import/file'"
...
export default {
  ...
  data() {
    return {
      productionUrl: this.GLOBAL.BASE_URL + '/demo/api/kvsc/acit/import/file',
      // 日志分页
      paginationLog: {
        current: 1,
        size: 20
