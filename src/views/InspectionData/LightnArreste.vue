<template>
  <div class="app-container">
    ...
    <!--  <el-table-column align="center" label="创建时间" width="150" :show-overflow-tooltip="true">
      ...
      <el-table-column align="center" :label="$t('permission.inspectionReportFileBLQ')" width="150" :show-overflow-tooltip="true">
        <template slot-scope="scope">
      ...
      <el-form ref="ruleForm" v-loading="editLoading" :model="ruleForm" :rules="rules" label-width="150px" class="demo-ruleForm">
        <div class="bigUpBox">
          ...
          <div class="boxRight">
            ...
            <el-form-item label="额定电压 " prop="refDCVoltageUn">
              <el-input v-model="ruleForm.refDCVoltageUn" />
            </el-form-item>
            <el-form-item label="1mA直流参考电压" prop="refDCVoltage">
              <el-input v-model="ruleForm.refDCVoltage" />
            </el-form-item>
            <el-form-item label="电站类型" prop="voltageType">
              <el-input v-model="ruleForm.voltageType" />
            </el-form-item>
            <el-tooltip class="item" effect="dark" content="0.75倍直流参考电压时泄露电流 " placement="top-start">
              <el-form-item label="0.75倍直流参考电压时泄露电流" prop="leakageCurrentDC">
                <el-input v-model="ruleForm.leakageCurrentDC" />
              </el-form-item>
            </el-tooltip>
            <el-form-item label="工单计划开始时间" prop="WorkNoStart">
              <el-input v-model="ruleForm.WorkNoStart" />
            </el-form-item>
            <el-form-item label="整装序列号" prop="MaterialSN">
              <el-input v-model="ruleForm.MaterialSN" />
            </el-form-item>
            <el-form-item label="避雷器批次号" prop="rmLot">
              <el-input v-model="ruleForm.rmLot" />
            </el-form-item>
            <el-form-item label="原材料批次号" prop="rmNumber">
